...
export class DateRangeFieldCustom extends Component {
    setup() {
    ...
    onChangeInput(ev) {
        ...
        try {
            ...
            console.log(this.startDate, this.endDate, 'value')
        } catch {
            this.props.record.setInvalidField(this.props.name);
            return;
        }
    ...
    async onPickerApply(ev, picker) {
        ...
        const input = document.querySelector(
            `.o_field_daterange_customer[name='${this.relatedDateRangeField}'] input`
        )
        console.log(this.relatedDateRangeField)
...
DateRangeFieldCustom.template = "loilv_report_advanced.DateRangeFieldCustomer";
DateRangeFieldCustom.props = {
    ...standardFieldProps,
...
export const dateRangeFieldCustomer = {
    component: DateRangeFieldCustom,
...
registry.category("fields").add("daterange_customer", dateRangeFieldCustomer);